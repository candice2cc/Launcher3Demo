 ...
 */
public class QsbContainerView2 extends FrameLayout {

    public QsbContainerView2(Context context) {
        super(context);
    }

    public QsbContainerView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public QsbContainerView2(Context context, AttributeSet attrs, int defStyleAttr) {
